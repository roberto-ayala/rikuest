// Pure, static UI configuration maps.
// These used to live inside uiStore; they are plain data with no store state.
...
export const getBackgroundColors = () => BACKGROUND_COLORS;
...
export const getColorConfig = (colorName = 'slate') =>
  COLOR_CONFIGS[colorName] || COLOR_CONFIGS.slate;
...
export const getSizeConfig = (size = 'md') => SIZE_CONFIGS[size] || SIZE_CONFIGS.md;
